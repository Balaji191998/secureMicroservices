...
{
    public partial class db_balajiContext : DbContext
    {
        public db_balajiContext()
        {
        }

        public db_balajiContext(DbContextOptions<db_balajiContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=DESKTOP-B1KC48A;Database=db_balaji;User ID=sa;Password=97yE}r6t_]7p#TPwR;Integrated Security=false;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CmsDictionary>(entity =>
            {
                ...
                entity.HasIndex(e => e.Parent)
                    .HasName("IX_cmsDictionary_Parent");
            ...
            modelBuilder.Entity<TblCustomer>(entity =>
            {
                entity.HasKey(e => e.Customerno)
                    .HasName("PK__tbl_cust__A492B3FB52783738");
                ...
                entity.Property(e => e.CustomerNmae)
                    .IsRequired()
                    .HasMaxLength(50)
                    .IsUnicode(false);
                ...
                entity.Property(e => e.CustomerOrderedDate)
                    .HasColumnName("Customer_ordered_date")
            ...
            modelBuilder.Entity<TblEmployee>(entity =>
            {
                entity.HasKey(e => e.EmployeId)
                    .HasName("PK__tbl_empl__C0B77A5664E14A79");
                ...
                entity.Property(e => e.EmployeeDep)
                    .IsRequired()
                    .HasColumnName("employee_dep")
                    .HasMaxLength(50)
                    .IsUnicode(false);

                entity.Property(e => e.EmployeeJoiningDate)
                    .HasColumnName("employee_joining_date")
                    .HasColumnType("datetime");

                entity.Property(e => e.EmployeeNmae)
                    .IsRequired()
                    .HasColumnName("employee_Nmae")
                    .HasMaxLength(50)
                    .IsUnicode(false);
            ...
            modelBuilder.Entity<UmbracoContentVersion>(entity =>
            {
                ...
                entity.HasIndex(e => new { e.NodeId, e.Current })
                    .HasName("IX_umbracoContentVersion_NodeId");
